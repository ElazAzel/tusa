DO $$
BEGIN
  IF to_regclass('public.chat_messages') IS NOT NULL AND to_regclass('public.party_gallery_photos') IS NOT NULL AND to_regclass('public.parties') IS NOT NULL THEN
