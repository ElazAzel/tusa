...
export const SITE_ORIGIN = (process.env.NEXT_PUBLIC_SITE_URL || "https://tusagame.vercel.app").replace(/\/$/, "");
export const CONTENT_UPDATED_AT = new Date("2026-07-12T00:00:00.000Z");
