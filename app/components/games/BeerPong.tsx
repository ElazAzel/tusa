...
export default function BeerPong({ sessionId, onSave, role }: { partyId: string; sessionId?: string | null; onSave: (score: number) => void; role?: "stage" | "controller" }) {
  ...
  const copy = locale === "ru" ? { title: "Бир-понг", teamA: "Команда A", teamB: "Команда B", hit: "Попадание", restore: "Вернуть", finish: "Завершить", win: "Победа" } : { title: "Beer Pong", teamA: "Team A", teamB: "Team B", hit: "Hit", restore: "Restore", finish: "Finish", win: "Winner" };
