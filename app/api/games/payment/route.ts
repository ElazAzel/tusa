...
import { getPaymentAssignee, requirePartyMember, setPaymentAssignee } from "@/lib/parties";
...
export async function POST(request: Request) {
  try {
    ...
    const result = await setPaymentAssignee(body.partyId, actor.id, body.targetUserId);
