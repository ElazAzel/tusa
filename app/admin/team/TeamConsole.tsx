...
const permissionGroups: {
  ...
  {
    titleRu: "Кастомизация",
    titleEn: "Cosmetics",
    items: ["cosmetics_read", "cosmetics_write"],
  },
  {
  ...
  const labels: Record<AdminPermission, string> =
    locale === "ru"
      ? {
          ...
          cosmetics_read: "Смотреть кастомизацию",
          cosmetics_write: "Менять кастомизацию",
      ...
      : {
          ...
          cosmetics_read: "View cosmetics",
          cosmetics_write: "Edit cosmetics",
